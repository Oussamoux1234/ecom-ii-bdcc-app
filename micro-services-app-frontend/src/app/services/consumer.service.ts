...
export class ConsumerService {
    /**
     * Gateway URL - all requests go through the API Gateway.
     * Using discovery locator routing pattern: /{service-name}/api/...
     */
    ...
    // ============================================
    // Product Operations (→ inventory-service)
    // ============================================
    ...
    // ============================================
    // Bill Operations (→ billing-service)
    // ============================================
